      ...
      <div class="table-responsive">
        ...
        ?>
            <tr>
              ...
              <td><a href="edit.php?codigo_usuario=<?php echo $res['id_usuario'];?>" class="btn btn-sm btn-outline-secondary">Editar</a> <a href="eliminar_usuario.php?codigo_usuario=<?php echo $res['id_usuario'];?>" class="btn btn-sm btn-outline-secondary">Eliminar</a></td>
            </tr>
        <?php    
        }
        mysqli_close($msqli);
